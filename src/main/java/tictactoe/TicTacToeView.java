...
/**
The TicTacToeView class displays a TicTacToe game on a GUI.
...
public class TicTacToeView extends JPanel{
    ...
    /**
    Creates a new graphical TicTacToe game display
    ...
    */
    ...
    private JPanel makeGameTextLabel(){
        ...
        panel.add(new JLabel("Welcome to TicTacToe"));
    ...
    private void enterNumber(ActionEvent e){
        ...
        try{
            String piece = JOptionPane.showInputDialog(game.getGameStateMessage()); 
            ...
            if(game.takeTurn(clicked.getAcross(), clicked.getDown(), piece)){
                ...
                JOptionPane.showMessageDialog(null, "Invalid Position or Piece"); 
            }
        }catch (Exception ex){
    ...
    /**
    Saves the current instance of a TicTacToe game to a file via a formatted string
    */
    ...
    /**
    Loads a TicTacToe game from a formatted stirng in a file to the current instance of the game
    */
